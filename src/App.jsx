...
// import { List, AddButtonList, Tasks } from "./components/export";

import List from "./components/List/List";
import AddButtonList from "./components/List/AddButtonList/AddButtonList";
...
function App() {
  ...
  //Изменение активного списка в зависимости адресной строки
  useEffect(() => {
    ...
    <div className="todo">
      <div className="todo__sidebar">
...

        {
          ...
          <AddButtonList onAdd={onAdd} colors={colors} />
        }
      </div>
